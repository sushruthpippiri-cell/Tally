...
from app.api import agent_protocol, agents, auth, commands, companies, health, users
...
def create_app(config: Settings | None = None) -> FastAPI:
    ...
    for module in (health, auth, companies, users, settings_api, agents, agent_protocol, commands):
